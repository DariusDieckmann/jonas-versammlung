                ...
                <div className="bg-white rounded-lg shadow-sm p-8 md:p-12">
                    ...
                    <div className="prose prose-gray max-w-none">
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-gray-700 leading-relaxed mb-4">
                                Wir nutzen Cloudflare als CDN und
                                Hosting-Provider. Dies dient der Sicherheit und
                                der Optimierung der Geschwindigkeit unserer
                                Website gemäß Art. 6 Abs. 1 lit. f DSGVO.
                            </p>
                            <p className="text-gray-700 leading-relaxed">
                                Anbieter ist Cloudflare Inc., 101 Townsend St.,
                                San Francisco, CA 94107, USA. Weitere
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <p className="text-gray-700 leading-relaxed">
                                        ...
                                        darüber zu verlangen, ob betreffende
                                        Daten verarbeitet werden und auf
                                        Auskunft über diese Daten sowie auf
                                        weitere Informationen und Kopie der
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700 leading-relaxed">
                                        ...
                                        unrichtiger oder auf Vervollständigung
                                        richtiger Daten gemäß Art. 16 DSGVO.
                                    </p>
                                </div>
                                <div>
                                    <h3 className="text-lg font-semibold text-gray-800 mb-2">
                                    ...
                                    <p className="text-gray-700 leading-relaxed">
                                        Sie haben ein Recht auf Löschung Ihrer
                                        bei uns gespeicherten Daten gemäß Art.
                                        17 DSGVO.
                                    </p>
                                </div>
                                <div>
                                    ...
                                    <p className="text-gray-700 leading-relaxed">
                                        ...
                                        Erfüllung eines Vertrags automatisiert
                                        verarbeiten, an sich oder an einen
                                        Dritten in einem gängigen,
                                        maschinenlesbaren Format aushändigen zu
                                        lassen gemäß Art. 20 DSGVO.
                                    </p>
                                </div>
                            </div>
                        </section>
